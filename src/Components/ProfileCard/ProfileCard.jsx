  ...
  <div className="card">
    ...
    <div className="bottom">
      <div className="content">
        <span className="name">Nitesh Chand</span>
        <span className="about-me">Cursed with creativity. Blessed with clarity. I write so your audience listens.</span>
        <span className="about-me-more">I’ve had an eye for detail and a passion for expressing my thoughts on a blank page. Over time, writing became more than a passion, it became my craft.
</span>
      </div>

      <div className="bottom-bottom">
        <div className="social-links-container">
            <a href="https://www.instagram.com/nick_the_comedian/" target="_blank">
